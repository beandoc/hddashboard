...
def upgrade() -> None:
    ...
    # ── access_episodes ───────────────────────────────────────────────────────
    if "access_episodes" not in tables:
        op.create_table(
            "access_episodes",
    ...
    if "access_surveillance_records" not in tables:
        op.create_table(
            "access_surveillance_records",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("patient_id", sa.Integer(), nullable=False),
    ...
    if "access_alert_overrides" not in tables:
        op.create_table(
            "access_alert_overrides",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("patient_id", sa.Integer(), nullable=False),
