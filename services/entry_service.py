...
def save_monthly_record(
    ...
    try:
        ...
        fields = dict(
            ...
            esa_modified_at=_d(data.get("esa_modified_at")),
            desidustat_modified_at=_d(data.get("desidustat_modified_at")),
            ...
            phosphate_binder_modified_at=_d(data.get("phosphate_binder_modified_at")),
