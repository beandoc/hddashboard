...
def update_patient_record(db: Session, patient_id: int, data: dict) -> Patient:
    ...
    p.hd_day_2 = data.get("hd_day_2", p.hd_day_2)
    p.hd_day_3 = data.get("hd_day_3", p.hd_day_3)
    p.hd_slot_1 = data.get("hd_slot_1", p.hd_slot_1)
    p.hd_slot_2 = data.get("hd_slot_2", p.hd_slot_2)
    p.hd_slot_3 = data.get("hd_slot_3", p.hd_slot_3)
