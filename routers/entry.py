...
async def save_entry(
    ...
    esa_type: str = Form(""),
    esa_modified_at: Optional[str] = Form(None),
    desidustat_modified_at: Optional[str] = Form(None),
    phosphate_binder_modified_at: Optional[str] = Form(None),
    ...
    hospitalization_discharge_date: list[str] = Form([]),
    hospitalization_los: list[str] = Form([]),
